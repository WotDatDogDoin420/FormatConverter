    ...
    public class ExcelService
    {
        ...
        public string ConvertExcelToXml(Stream fileStream, string originalFileName)
        {
            ...
            try
            {
                ...
                string xmlFileName = Path.GetFileNameWithoutExtension(originalFileName) + ".xml";
                string xmlOutputPath = Path.Combine(Path.GetTempPath(), xmlFileName);

                File.WriteAllText(xmlOutputPath, xmlResult);
